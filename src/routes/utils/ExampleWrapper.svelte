...
<div class="mt-8 code-example" bind:this={node} use:init>
	{#if !meta.hideOutput}
		<div class="code-preview-wrapper">
			<div
				class="flex p-0 bg-white border-gray-200 bg-gradient-to-r code-preview dark:bg-gray-900 border-x border-t dark:border-gray-600" class:dark
			>
			...
			<div class="relative">
				...
				{#if showExpandButton && !expand}
					<button
						...
						data-expand-code=""
						type="button"
						class="absolute bottom-0 start-0 py-2.5 px-5 w-full text-sm font-medium text-gray-900 bg-gray-100 border-t border-gray-200 hover:bg-gray-100 hover:text-primary-700 dark:bg-gray-700 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
					>
						Expand code
					</button>
				{/if}
