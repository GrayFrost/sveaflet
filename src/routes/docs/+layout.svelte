...
>
	<SidebarWrapper
		divClass="overflow-y-auto px-4 pt-20 pb-4 lg:pt-0 h-full bg-white scrolling-touch max-w-2xs lg:h-[calc(100vh-60px)] lg:block dark:bg-gray-900 lg:me-0 lg:sticky top-20"
	>
